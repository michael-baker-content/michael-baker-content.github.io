...
export const projects: Project[] = [
	{
		slug: 'bakerlinks',
		name: 'BakerLinks',
		description: 'My new app lets you create a customizable profile page. You add your links, customize the look, and optionally add an About page with markdown content.',
		overview: `This is my first attempt at working with user authorization and Superbase data storage.`,
		repoUrl: 'https://github.com/michael-baker-content/bakerlinks',
		liveUrl: 'https://bakerlinks.com',
		tags: ["nextjs", "vercel", "supabase", "auth", "react", "platform"],
		status: 'complete',
		type: 'web-app',
	...
	},
	{
		...
		blogPosts: ['building-this-blog.mdx'],
		featured: false,
